...
public class pidsupdate {
    ...
    static void updateSinglePidsDisplay(String stacode, String plat, ArrayList<deprec> depreclist, String pidsindex, boolean clear) {
        ...
        for (int count = 0; count < linesize * height; count++) {
            ...
            for (int i = 0; i < signsize; i++) {
                ...
                String trainname = thisdeprec.getName();
                if (!clear) {
